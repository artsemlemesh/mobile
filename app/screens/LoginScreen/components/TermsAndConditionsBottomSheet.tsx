...
const TermsAndConditionsBottomSheet: React.FC<TermsAndConditionsBottomSheetProps> = React.forwardRef(
  (_, ref) => {
      ...
      <Modalize
        ...
        <View style={styles().content}>
          ...
          <Text style={styles(theme).termsText}>
            ...
            FOR YOURSELF OR ON BEHALF OF THOSE YOU REPRESENT, DO NOT AGREE TO
            ANY PROVISION OF THESE TERMS, YOU MUST, FOR YOURSELF AND ON BEHALF
            ANY SUCH PERSON(S), DISCONTINUE THE REGISTRATION PROCESS.
          </Text>

          <Text style={styles(theme).termsTitleText}>
            Modification of Terms
          </Text>
          <Text style={styles(theme).termsText}>
            Bynde (“Bynde”, “we”, “us” or “our”) provides a free and open source
            platform via its apps to a community of registered users (“users” or
            “you”) to engage in a variety of activities, including to upload and
            display photographs (“Visual Content”), share comments, opinions,
            and ideas, promote Visual Content The foregoing list of Services is
            not all-inclusive and additional Services may be offered by us from
            time to time. The following are the terms of use (“Terms”) for using
            the Site and the Services.
          </Text>

          <Text style={styles(theme).termsTitleText}>Data Usage</Text>
          <Text style={styles(theme).termsText}>
            As mentioned Bynde is an open source app with it's source code
            hosted on github, the data you generate is not used against you in
            any shape or form like sharing with 3rd parties or targeting you for
            ads using machine learning algorithms
          </Text>

          <Text style={styles(theme).termsTitleText}>Registration</Text>
          <Text style={styles(theme).termsText}>
            Services are available to authorized representatives of legal
            entities and to individuals who are either (i) at least 18 years old
            to register for Bynde, or (ii) at least 14 years old, and who are
            ...
            the Site by the minor. Parents and legal guardians are warned that
            the Site does display Visual Content containing nudity and violence
            that may be offensive to some.
          </Text>

          <Text style={styles(theme).termsTitleText}>User Conduct</Text>
          <Text style={styles(theme).termsText}>
            All Visual Content posted or otherwise submitted to the Site, and
            any comments, or other communications (“Communications”, with Visual
            ...
            Communications originate. You acknowledge and agree that you, and
            not Bynde, are entirely responsible for all Content that you post,
            or otherwise submit to the Site, including via messages exchanged
            through Bynde’s messenger service. Bynde does not control user
          ...
          <Text style={styles(theme).termsText}>
            As a condition of use, you promise to abide by our Content
            Guidelines and not to use the Services for any purpose that is
            unlawful or prohibited by these Terms, or any other purpose not
            reasonably intended by Bynde. By way of example, and not as a
          ...
          <Text style={styles(theme).subPoints}>
            3) To communicate with Bynde’s representatives or other users in an
            abusive or offensive manner.
          </Text>
          <Text style={styles(theme).subPoints}>
            4) For any purpose (including posting or viewing Content) that is
          ...
          <Text style={styles(theme).subPoints}>
            ...
            private information from any Bynde user.
          </Text>
          <Text style={styles(theme).subPoints}>
          ...
          <Text style={styles(theme).subPoints}>
            8) To post copyrighted Content that does not belong to you, unless
          ...
          <Text style={styles(theme).subPoints}>
            9) You agree not to use any robot, spider, scraper, or other
            ...
            not take any action that imposes, or may impose in our sole
            ...
            working of the Platform or any activities conducted on the Site or
          ...
          <Text style={styles(theme).subPoints}>
            ...
            receiving money or other compensation in exchange for votes and/or
            in an attempt to alter the result of any contest or promotion, or
          ...
          <Text style={styles(theme).subPoints}>
            12) To promote or sell Visual Content of another person unless you
          ...
          <Text style={styles(theme).subPoints}>
            ...
            guideline will lead to a permanent ban effective immediately from
            the platform.
          </Text>
          <Text style={styles(theme).termsText}>
            You are solely responsible for your interactions with other users of
            the Site. Bynde reserves the right, but has no obligation, to review
            disputes between you and other users. This includes the right to
            review messages exchanged through Bynde’s messenger service, based
            on any reports that Bynde receives alleging the violation of these
            Terms through the use of Bynde’s messenger service, including
            without limitation, reports regarding alleged harassment, indecency,
