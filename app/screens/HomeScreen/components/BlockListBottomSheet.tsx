...
const BlockListBottomSheet: React.FC<
  BlockListBottomSheetProps
> = React.forwardRef(({ onUnblock }, ref) => {
  ...
  // const [
  //   unblockUser,
  //   {loading: unblockUserLoading, called: unblockUserCalled},
  // ] = useMutation(MUTATION_UNBLOCK_USER);
    ...
    return (
      <Swipeable
        ...
        renderRightActions={(progress, dragX) =>
          renderRightActions(progress, dragX, id, handle)
        }>
        <UserCard
          userId={id}
          avatar={avatar}
