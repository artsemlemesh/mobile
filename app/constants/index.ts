...
export const Routes: RoutesType = {
  ...
  ListingItemList: 'ListingItemList',
  ListingItemDetail: 'ListingItemDetail',
  PurchaseScreen: 'PurchaseScreen',
  AddressFlow: 'AddressFlow',
  SellingPurchaseScreen : 'SellingPurchaseScreen',
  PaymentSuccess: 'PaymentSuccess',
  SellingSingleDetail : 'SellingSingleDetail',
...
export const AuthDefaults: AuthDefaultsType = {
  avatar:
    'https://firebasestorage.googleapis.com/v0/b/proximity-406e5.appspot.com/o/defaults%2Favatar-default.png?alt=media&token=23a37081-e594-4184-ba9f-c986ee9d3c41',
  name: 'Proximity user',
};
